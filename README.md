...
At the `community.proxmox` collection, our mission is to produce and maintain simple, flexible,
...
Ansible-core 2.15, 2.16, 2.17, 2.18, and the current development version of ansible-core.
