...
API_RESPONSES = {
    ...
    "https://localhost:8006/api2/json/nodes/testnode/qemu": [
        {
            "name": "test-qemu",
            "cpus": 1,
            "mem": 1000,
    ...
    "https://localhost:8006/api2/json/nodes/testnode/lxc/100/config": {
        "console": 1,
    ...
    "https://localhost:8006/api2/json/nodes/testnode/qemu/101/config": {
        "tags": "one, two, three",
        "cores": 1,
    ...
    "https://localhost:8006/api2/json/nodes/testnode/qemu/102/config": {
        "numa": 0,
    ...
    "https://localhost:8006/api2/json/nodes/testnode/qemu/103/config": {
    ...
    "https://localhost:8006/api2/json/nodes/testnode/qemu/101/agent/network-get-interfaces": {
        "result": [
            {
    ...
    "https://localhost:8006/api2/json/nodes/testnode/qemu/102/agent/network-get-interfaces": {
        "result": {"error": {"desc": "this feature or command is not currently supported", "class": "Unsupported"}},
    },
    "https://localhost:8006/api2/json/nodes/testnode/qemu/103/agent/network-get-interfaces": {
        "result": [
            {
                "statistics": {
                    "tx-errs": 0,
    ...
    "https://localhost:8006/api2/json/nodes/testnode/lxc/100/status/current": {
        "swap": 0,
        "name": "test-lxc",
        "diskread": 0,
        "vmid": 100,
    ...
    "https://localhost:8006/api2/json/nodes/testnode/qemu/101/status/current": {
        "status": "stopped",
        "uptime": 0,
        "maxmem": 5364514816,
        "maxdisk": 34359738368,
    ...
    "https://localhost:8006/api2/json/nodes/testnode/qemu/102/status/current": {
        "status": "stopped",
        "uptime": 0,
        "maxmem": 5364514816,
        "maxdisk": 34359738368,
    ...
    "https://localhost:8006/api2/json/nodes/testnode/qemu/103/status/current": {
        "status": "stopped",
        "uptime": 0,
        "maxmem": 5364514816,
        "maxdisk": 34359738368,
