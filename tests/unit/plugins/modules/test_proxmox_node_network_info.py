...
class TestProxmoxNodeNetworkInfoSimple(ModuleTestCase):
    def setUp(self):
        super(TestProxmoxNodeNetworkInfoSimple, self).setUp()
    ...
    def tearDown(self):
        ...
        super(TestProxmoxNodeNetworkInfoSimple, self).tearDown()
