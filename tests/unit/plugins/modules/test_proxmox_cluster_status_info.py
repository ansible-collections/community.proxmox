# Copyright (c) 2026, Michael Dombek (@michaelwdombek)
#
...
CLUSTER_STATUS = [
    {"id": "cluster", "name": "testcluster", "nodes": 3, "quorate": True, "type": "cluster", "version": 5},
    {
        "id": "node/node1",
        "ip": "192.168.1.10",
        "level": "c",
...
def mock_api_cluster_status(mocker):
    ...
    raw_response = [
        {"id": "cluster", "name": "testcluster", "nodes": 3, "quorate": 1, "type": "cluster", "version": 5},
        {
            "id": "node/node1",
            "ip": "192.168.1.10",
            "level": "c",
