...
RAW_SUBNETS = [
    {
        ...
        "mask": "24",
        "dhcp-range": [
            {"start-address": "10.10.2.5", "end-address": "10.10.2.25"},
            {"start-address": "10.10.2.50", "end-address": "10.10.2.100"},
        ],
...
class TestProxmoxSubnetModule(ModuleTestCase):
    def setUp(self):
        ...
        self.version_mock = patch.object(
            proxmox_subnet.ProxmoxSubnetAnsible, "version", return_value=LooseVersion("9.0")
        ).start()
