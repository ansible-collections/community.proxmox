...
RAW_ZONES = [
    ...
    {"zone": "vxlan-fabric-zone", "digest": "abc123def456", "type": "vxlan", "fabric": "my-fabric", "mtu": 1450},
    {
    ...
    {"zone": "simple-zone", "digest": "xyz789", "type": "simple"},
]
...
class TestProxmoxZoneModule(ModuleTestCase):
    def setUp(self):
        ...
        self.version_mock = patch.object(
            proxmox_zone.ProxmoxZoneAnsible, "version", return_value=LooseVersion("9.0")
        ).start()
        self.connect_mock.return_value.cluster.return_value.sdn.return_value.zones.return_value.get.return_value = (
            RAW_ZONES
        )
